<?php
/*
 Template name: Fiche_Saturn_PAL
*/
 get_header(); ?>
<style type="text/css">
body{
				...
				<div class="row packages droite">
					<div class="package">
						...
						<ul>
							...
							<li><strong class="title_tab">Développeur :</strong><span class="donnees"> <?php echo $donnees['DEVELOPPEUR'];
						}
					}
					?></span></li>
				</ul>
						...
						<tr class="ligne_tab">
							...
							<td><?php if ($donnees['Commentaires'] != "Insérez votre commentaire ici"){
								echo $donnees['Commentaires'];}
									...
									echo "";}?></td>
									<td><a href="/../cart"><?php echo do_shortcode('[wp_cart_button name="' . $donnees['Titre_du_jeu'] . '" price="' . $donnees['Prix'] . '"]');
