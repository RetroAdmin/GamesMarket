		...
		<table id="tableid">
			<tbody>
				...
				foreach ($results as $key => $value) {
					...
					elseif ($value->REGION == 'CAN') {
						echo '<td><img src="/img/flags/can_flag.png" alt="can_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'MEX') {
						echo '<td><img src="/img/flags/mex_flag.png" alt="mex_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'CHN') {
						echo '<td><img src="/img/flags/chn_flag.png" alt="chn_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'KOR') {
						echo '<td><img src="/img/flags/kor_flag.png" alt="kor_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'TWN') {
						echo '<td><img src="/img/flags/twn_flag.png" alt="twn_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'MAL') {
						echo '<td><img src="/img/flags/mal_flag.png" alt="mal_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'BRA') {
						echo '<td><img src="/img/flags/bra_flag.png" alt="bra_flag" width="20px" style="margin-bottom:0;"/></td>';
					}
					elseif ($value->REGION == 'ARG') {
						echo '<td><img src="/img/flags/arg_flag.png" alt="arg_flag" width="20px" style="margin-bottom:0;"/></td>';
					};
